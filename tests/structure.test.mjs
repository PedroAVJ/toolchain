...
test("standalone plugin metadata is synchronized", async () => {
  ...
  await access(join(root, "assets", "toolchain-icon.png"));
  assert.equal(codex.interface.composerIcon, "./assets/toolchain-icon.png");
  assert.equal(codex.interface.logo, "./assets/toolchain-icon.png");
